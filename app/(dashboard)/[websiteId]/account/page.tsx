    ...
    <>
      ...
      <div className="grid grid-cols-12 items-start">
        <form className="col-span-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col justify-start items-start gap-4">
            <Label className="font-bold" htmlFor="profilePicture">
              Photo du compte
            </Label>
        ...
        <div className="col-span-4 flex flex-col gap-4 p-8 bg-primary text-white rounded-2xl">
          <h2 className="text-2xl font-bold">
            Besoin de changer d’autres informations ?
          </h2>
          <p>
            Pour des raisons de sécurité, certaines informations ne sont pas 
            modifiables sur cette page. N’hésitez pas à contacter l’équipe de 
            support si vous souhaitez changer votre adresse mail ou votre mot de
             passe.</p>
          <p>
            Ces modifications sont limitées et seront facturées une fois un 
            seuil dépassé.
          </p>
        </div>
      </div>
